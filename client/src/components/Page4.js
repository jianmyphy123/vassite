...
import { page4Request } from '../actions/pageActions';
...
class Page4 extends React.Component {
  ...
  constructor(props) {
    ...
    this.props.page4Request().then(({data}) => {
                ...
                <div className="row m-t-20">
                  <div className="card-box inner-box" style={{minHeight: 800}}>
                    ...
                    <div className="row page-header">
                        <span className="page-title"> Page 4 Table </span>
                    </div>
...
export default connect(null, { page4Request })(Page4);

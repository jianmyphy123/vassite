...
import { page7Request } from '../actions/pageActions';
...
class Page7 extends React.Component {
  ...
  constructor(props) {
    ...
    this.props.page7Request().then(({data}) => {
                ...
                <div className="row m-t-20">
                  <div className="card-box inner-box" style={{minHeight: 800}}>
                    ...
                    <div className="row page-header">
                        <span className="page-title"> Page 7 Table </span>
                    </div>
...
export default connect(null, { page7Request })(Page7);

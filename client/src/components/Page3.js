...
import { page3Request } from '../actions/pageActions';
...
class Page3 extends React.Component {
  ...
  constructor(props) {
    ...
    this.props.page3Request().then(({data}) => {
                ...
                <div className="row m-t-20">
                  <div className="card-box inner-box" style={{minHeight: 800}}>
                    ...
                    <div className="row page-header">
                        <span className="page-title"> Page 3 Table </span>
                    </div>
...
export default connect(null, { page3Request })(Page3);
